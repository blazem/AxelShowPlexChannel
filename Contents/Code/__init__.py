NAME = 'Axel Show! Channel'
ART = 'art-default.jpg'
ICON = 'icon-default.png'
SEARCH_ICON = 'icon-search.png'
BASE_URL = 'http://www.reddit.com/r/axelshow.json'
SEARCH_URL = 'http://www.reddit.com/r/axelshow/search.json?q=%s&restrict_sr=on'
